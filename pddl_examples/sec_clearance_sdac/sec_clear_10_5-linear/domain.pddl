(define (domain security-clearance)
	...
	(:action authorize_all_d7
		:parameters ( )
		:precondition (and (>= (priority_d7) (high)) (not (clear_d7_l1)) (not (clear_d7_l2)) (not (clear_d7_l3)) (not (clear_d7_l4)) (not (clear_d7_l5)) )
		:effect (and (clear_d7_l1) (clear_d7_l2) (clear_d7_l3) (clear_d7_l4) (clear_d7_l5) (increase (cost_d7) 5))
	)
	...
	(:action authorize_d7_l5
		:parameters ( )
		:precondition (and (not (clear_d7_l5)))
		:effect (and (clear_d7_l5) (not (clear_d7_l1)) (not (clear_d7_l2)) (not (clear_d7_l3)) (not (clear_d7_l4)) (increase (cost_d7) 5))
	)
	...
	(:action authorize_all_d8
		:parameters ( )
		:precondition (and (>= (priority_d8) (high)) (not (clear_d8_l1)) (not (clear_d8_l2)) (not (clear_d8_l3)) (not (clear_d8_l4)) (not (clear_d8_l5)) )
		:effect (and (clear_d8_l1) (clear_d8_l2) (clear_d8_l3) (clear_d8_l4) (clear_d8_l5) (increase (cost_d8) 5))
	)
	...
	(:action authorize_d8_l5
		:parameters ( )
		:precondition (and (not (clear_d8_l5)))
		:effect (and (clear_d8_l5) (not (clear_d8_l1)) (not (clear_d8_l2)) (not (clear_d8_l3)) (not (clear_d8_l4)) (increase (cost_d8) 5))
	)

	(:action increase_priority_d9
		:parameters ( )
		:precondition (and (< (priority_d9) (high)) )
		:effect (and (increase (priority_d9) 1) (increase (cost_d9) (priority_d9) ))
	)

	(:action authorize_all_d9
		:parameters ( )
		:precondition (and (>= (priority_d9) (high)) (not (clear_d9_l1)) (not (clear_d9_l2)) (not (clear_d9_l3)) (not (clear_d9_l4)) (not (clear_d9_l5)) )
		:effect (and (clear_d9_l1) (clear_d9_l2) (clear_d9_l3) (clear_d9_l4) (clear_d9_l5) (increase (cost_d9) 5))
	)

	(:action authorize_d9_l1
		:parameters ( )
		:precondition (and (not (clear_d9_l1)))
		:effect (and (clear_d9_l1) (increase (cost_d9) 1))
	)

	(:action authorize_d9_l2
		:parameters ( )
		:precondition (and (not (clear_d9_l2)))
		:effect (and (clear_d9_l2) (not (clear_d9_l1)) (increase (cost_d9) 2))
	)

	(:action authorize_d9_l3
		:parameters ( )
		:precondition (and (not (clear_d9_l3)))
		:effect (and (clear_d9_l3) (not (clear_d9_l1)) (not (clear_d9_l2)) (increase (cost_d9) 3))
	)

	(:action authorize_d9_l4
		:parameters ( )
		:precondition (and (not (clear_d9_l4)))
		:effect (and (clear_d9_l4) (not (clear_d9_l1)) (not (clear_d9_l2)) (not (clear_d9_l3)) (increase (cost_d9) 4))
	)

	(:action authorize_d9_l5
		:parameters ( )
		:precondition (and (not (clear_d9_l5)))
		:effect (and (clear_d9_l5) (not (clear_d9_l1)) (not (clear_d9_l2)) (not (clear_d9_l3)) (not (clear_d9_l4)) (increase (cost_d9) 5))
	)

	(:action increase_priority_d10
		:parameters ( )
		:precondition (and (< (priority_d10) (high)) )
		:effect (and (increase (priority_d10) 1) (increase (cost_d10) (priority_d10) ))
	)

	(:action authorize_all_d10
		:parameters ( )
		:precondition (and (>= (priority_d10) (high)) (not (clear_d10_l1)) (not (clear_d10_l2)) (not (clear_d10_l3)) (not (clear_d10_l4)) (not (clear_d10_l5)) )
		:effect (and (clear_d10_l1) (clear_d10_l2) (clear_d10_l3) (clear_d10_l4) (clear_d10_l5) (increase (cost_d10) 5))
	)

	(:action authorize_d10_l1
		:parameters ( )
		:precondition (and (not (clear_d10_l1)))
		:effect (and (clear_d10_l1) (increase (cost_d10) 1))
	)

	(:action authorize_d10_l2
		:parameters ( )
		:precondition (and (not (clear_d10_l2)))
		:effect (and (clear_d10_l2) (not (clear_d10_l1)) (increase (cost_d10) 2))
	)

	(:action authorize_d10_l3
		:parameters ( )
		:precondition (and (not (clear_d10_l3)))
		:effect (and (clear_d10_l3) (not (clear_d10_l1)) (not (clear_d10_l2)) (increase (cost_d10) 3))
	)

	(:action authorize_d10_l4
		:parameters ( )
		:precondition (and (not (clear_d10_l4)))
		:effect (and (clear_d10_l4) (not (clear_d10_l1)) (not (clear_d10_l2)) (not (clear_d10_l3)) (increase (cost_d10) 4))
	)

	(:action authorize_d10_l5
		:parameters ( )
		:precondition (and (not (clear_d10_l5)))
		:effect (and (clear_d10_l5) (not (clear_d10_l1)) (not (clear_d10_l2)) (not (clear_d10_l3)) (not (clear_d10_l4)) (increase (cost_d10) 5))
	)
