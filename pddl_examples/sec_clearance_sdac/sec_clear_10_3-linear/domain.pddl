(define (domain security-clearance)
	...
	(:action authorize_all_d9
		:parameters ( )
		:precondition (and (>= (priority_d9) (high)) (not (clear_d9_l1)) (not (clear_d9_l2)) (not (clear_d9_l3)) )
		:effect (and (clear_d9_l1) (clear_d9_l2) (clear_d9_l3) (increase (cost_d9) 3))
	)
	...
	(:action authorize_all_d10
		:parameters ( )
		:precondition (and (>= (priority_d10) (high)) (not (clear_d10_l1)) (not (clear_d10_l2)) (not (clear_d10_l3)) )
		:effect (and (clear_d10_l1) (clear_d10_l2) (clear_d10_l3) (increase (cost_d10) 3))
	)
