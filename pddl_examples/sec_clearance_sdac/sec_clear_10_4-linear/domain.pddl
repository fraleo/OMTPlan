(define (domain security-clearance)
	...
	(:action authorize_all_d9
		:parameters ( )
		:precondition (and (>= (priority_d9) (high)) (not (clear_d9_l1)) (not (clear_d9_l2)) (not (clear_d9_l3)) (not (clear_d9_l4)) )
		:effect (and (clear_d9_l1) (clear_d9_l2) (clear_d9_l3) (clear_d9_l4) (increase (cost_d9) 4))
	)
	...
	(:action authorize_all_d10
		:parameters ( )
		:precondition (and (>= (priority_d10) (high)) (not (clear_d10_l1)) (not (clear_d10_l2)) (not (clear_d10_l3)) (not (clear_d10_l4)) )
		:effect (and (clear_d10_l1) (clear_d10_l2) (clear_d10_l3) (clear_d10_l4) (increase (cost_d10) 4))
	)
