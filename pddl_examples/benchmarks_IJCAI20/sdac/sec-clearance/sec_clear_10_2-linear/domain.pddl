(define (domain security-clearance)
	...
	(:action authorize_all_d4
		:parameters ( )
		:precondition (and (>= (priority_d4) (high)) (not (clear_d4_l1)) (not (clear_d4_l2)) )
		:effect (and (clear_d4_l1) (clear_d4_l2) (increase (cost_d4) 2))
	)
	...
	(:action authorize_all_d5
		:parameters ( )
		:precondition (and (>= (priority_d5) (high)) (not (clear_d5_l1)) (not (clear_d5_l2)) )
		:effect (and (clear_d5_l1) (clear_d5_l2) (increase (cost_d5) 2))
	)
	...
	(:action authorize_all_d6
		:parameters ( )
		:precondition (and (>= (priority_d6) (high)) (not (clear_d6_l1)) (not (clear_d6_l2)) )
		:effect (and (clear_d6_l1) (clear_d6_l2) (increase (cost_d6) 2))
	)
	...
	(:action authorize_all_d7
		:parameters ( )
		:precondition (and (>= (priority_d7) (high)) (not (clear_d7_l1)) (not (clear_d7_l2)) )
		:effect (and (clear_d7_l1) (clear_d7_l2) (increase (cost_d7) 2))
	)
	...
	(:action authorize_all_d8
		:parameters ( )
		:precondition (and (>= (priority_d8) (high)) (not (clear_d8_l1)) (not (clear_d8_l2)) )
		:effect (and (clear_d8_l1) (clear_d8_l2) (increase (cost_d8) 2))
	)
	...
	(:action authorize_all_d9
		:parameters ( )
		:precondition (and (>= (priority_d9) (high)) (not (clear_d9_l1)) (not (clear_d9_l2)) )
		:effect (and (clear_d9_l1) (clear_d9_l2) (increase (cost_d9) 2))
	)
	...
	(:action authorize_all_d10
		:parameters ( )
		:precondition (and (>= (priority_d10) (high)) (not (clear_d10_l1)) (not (clear_d10_l2)) )
		:effect (and (clear_d10_l1) (clear_d10_l2) (increase (cost_d10) 2))
	)
