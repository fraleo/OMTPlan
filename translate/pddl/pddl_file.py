...
import translate.pddl.parser as parser
import translate.pddl.tasks as tasks


def parse_pddl_file(type, filename):
    try:
        return parser.parse_nested_list(open(filename, 'r'))
    except IOError as e:
...
def open_file(task_filename=None, domain_filename=None):
